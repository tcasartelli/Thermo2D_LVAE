"""Vanilla LVAE for thermoelastic2D designs — GN encoder + latent noise injection.
...
@dataclass
class Args:
    """Command-line arguments for vanilla LVAE with latent noise training on thermoelastic2d."""
    ...
    images_dir: str = os.path.join(os.environ.get("SCRATCH", "."), "thermoelastic2d_lvae_latent_noise", "images")
    """Directory to save visualisation images."""
    checkpoint_dir: str = os.path.join(os.environ.get("SCRATCH", "."), "thermoelastic2d_lvae_latent_noise", "checkpoints")
...
if __name__ == "__main__":
    ...
    print(f"\n{'=' * 60}")
    print("Vanilla LVAE — thermoelastic2d [GN encoder + latent noise]")
    ...
    for epoch in range(args.n_epochs):
        ...
        if args.save_model and epoch == args.n_epochs - 1:
            ckpt_path = os.path.join(args.checkpoint_dir, "thermoelastic2d_vanilla_lvae_latent_noise.pth")
            th.save({
                "epoch"    : epoch,
